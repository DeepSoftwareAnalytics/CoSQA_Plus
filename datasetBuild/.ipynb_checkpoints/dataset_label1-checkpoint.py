...
def judge_match():
    ...
    output_file = "CoSQA-plus/dataset/human-label/half_match_human_query_code_pairs_1000_llama370b.csv"
    temp_file = "temp_output.csv"
    pickle_file = "CoSQA-plus/dataset/human-label/half_match_human_query_code_pairs_1000_llama370b.pkl"
    # 读取之前保存的 csv 文件
    try:
    ...
    now_index = 0
    # 最大线程数设为50
    with concurrent.futures.thread.ThreadPoolExecutor(max_workers=4) as executor:
        futures = []
        while now_index < l:
