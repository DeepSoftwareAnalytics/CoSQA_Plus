...
def judge_match():
    ...
    output_file = "CoSQA-plus/dataset/human-label/human_query_code_pairs_1000_claude3sonnet.json"
    temp_file = "temp_output.csv"
    pickle_file = "CoSQA-plus/dataset/human-label/human_query_code_pairs_1000_claude3sonnet.pkl"
    # 读取之前保存的 csv 文件
    try:
